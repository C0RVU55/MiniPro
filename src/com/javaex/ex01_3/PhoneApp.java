...
public class PhoneApp {
	...
	private static List<Person> pList; // 리스트 관련 기능을 뒤쪽에 static메소드로 뺄 거라 리스트도 static으로 선언
	
	public static void main(String[] args) throws IOException {

		// main만 이용하되 메소드로 기능 분리
		/* 시작시 파일 불러와서 리스트 추가 (가독성) : loadList()
		 * 리스트 화면 출력 기능 (1.리스트 4.검색) : showList() --> 생성자 없는 거 있는 거 2개 만들어서 메소드 오버로딩시킴
		 * 리스트의 모든 값 저장 기능 (2.등록 3.삭제) : saveList()
		 */
	...
	public static void showList() {
		showList(""); // 아래 함수 오버로딩 하는데 키워드 없는 값으로 전달
	}
