...
public class PhoneRepository {
	...
	// phoneDB.txt을 읽어 모든 전화번호(리스트)를 전달하는 메소드
	...
	// phoneDB.txt에 모든 전화번호 리스트를 저장하는 메소드
	...
	// 기존데이터에 새로 입력 받은 데이터를 추가하여 모두 저장하는 메소드
	public void addInfo(Person phoneVO) {
		pList.add(phoneVO);
		saveList();
	}

	// 선택한 번호의 데이터를 삭제하고 저장하는 메소드(모두 다시 저장)
